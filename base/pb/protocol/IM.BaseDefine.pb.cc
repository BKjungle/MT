...
const int OfflineFileInfo::kFileMd5FieldNumber;
const int OfflineFileInfo::kStatusFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_file_md5;
        break;
      }
...
#ifndef _MSC_VER
const int InfoNotify::kOfflineFileListFieldNumber;
#endif  // !_MSC_VER

InfoNotify::InfoNotify()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.BaseDefine.InfoNotify)
}

void InfoNotify::InitAsDefaultInstance() {
}

InfoNotify::InfoNotify(const InfoNotify& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.BaseDefine.InfoNotify)
}

void InfoNotify::SharedCtor() {
  _cached_size_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}

InfoNotify::~InfoNotify() {
  // @@protoc_insertion_point(destructor:IM.BaseDefine.InfoNotify)
  SharedDtor();
}

void InfoNotify::SharedDtor() {
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  if (this != &default_instance()) {
  #else
  if (this != default_instance_) {
...
void InfoNotify::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const InfoNotify& InfoNotify::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eBaseDefine_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eBaseDefine_2eproto();
...
InfoNotify* InfoNotify::default_instance_ = NULL;

InfoNotify* InfoNotify::New() const {
  return new InfoNotify;
}

void InfoNotify::Clear() {
  offline_file_list_.Clear();
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  mutable_unknown_fields()->clear();
}

bool InfoNotify::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.BaseDefine.InfoNotify)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(10)) goto parse_offline_file_list;
        if (input->ExpectAtEnd()) goto success;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:IM.BaseDefine.InfoNotify)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.BaseDefine.InfoNotify)
  return false;
#undef DO_
}

void InfoNotify::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.BaseDefine.InfoNotify)
  // repeated .IM.BaseDefine.OfflineFileInfo offline_file_list = 1;
  for (int i = 0; i < this->offline_file_list_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessage(
      1, this->offline_file_list(i), output);
  }

  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.BaseDefine.InfoNotify)
}

int InfoNotify::ByteSize() const {
  int total_size = 0;
...
void InfoNotify::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const InfoNotify*>(&from));
}

void InfoNotify::MergeFrom(const InfoNotify& from) {
  GOOGLE_CHECK_NE(&from, this);
  offline_file_list_.MergeFrom(from.offline_file_list_);
  mutable_unknown_fields()->append(from.unknown_fields());
}

void InfoNotify::CopyFrom(const InfoNotify& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool InfoNotify::IsInitialized() const {

  if (!::google::protobuf::internal::AllAreInitialized(this->offline_file_list())) return false;
  return true;
}

void InfoNotify::Swap(InfoNotify* other) {
  if (other != this) {
