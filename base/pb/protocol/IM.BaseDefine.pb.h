...
enum FileCmdID {
  ...
  CID_FILE_Notify__Ack = 1293,
  CID_FILE_Notify_dbserver = 1294
};
bool FileCmdID_IsValid(int value);
const FileCmdID FileCmdID_MIN = CID_FILE_LOGIN_REQ;
const FileCmdID FileCmdID_MAX = CID_FILE_Notify_dbserver;
...
enum OtherCmdID {
  ...
  CID_OTHER_FILE_DOWNLOAD_NOTIFY = 1845
};
bool OtherCmdID_IsValid(int value);
const OtherCmdID OtherCmdID_MIN = CID_OTHER_HEARTBEAT;
const OtherCmdID OtherCmdID_MAX = CID_OTHER_FILE_DOWNLOAD_NOTIFY;
...
const TransferType TransferType_MIN = FILE_UPLOAD;
const TransferType TransferType_MAX = FILE_DOWNLOAD;
...
enum FileStatus {
  FILE_NEED_DOWNLOAD = 1,
  FILE_NEED_DISPLAY = 0
};
bool FileStatus_IsValid(int value);
const FileStatus FileStatus_MIN = FILE_NEED_DISPLAY;
const FileStatus FileStatus_MAX = FILE_NEED_DOWNLOAD;
const int FileStatus_ARRAYSIZE = FileStatus_MAX + 1;
...
class OfflineFileInfo : public ::google::protobuf::MessageLite {
 public:
  ...
  static const int kFileMd5FieldNumber = 5;
...
class InfoNotify : public ::google::protobuf::MessageLite {
 public:
  InfoNotify();
  virtual ~InfoNotify();

  InfoNotify(const InfoNotify& from);

  inline InfoNotify& operator=(const InfoNotify& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const InfoNotify& default_instance();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const InfoNotify* internal_default_instance() {
    return default_instance_;
  }
  #endif

  void Swap(InfoNotify* other);

  // implements Message ----------------------------------------------

  InfoNotify* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
  void CopyFrom(const InfoNotify& from);
  void MergeFrom(const InfoNotify& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // repeated .IM.BaseDefine.OfflineFileInfo offline_file_list = 1;
  inline int offline_file_list_size() const;
  inline void clear_offline_file_list();
  static const int kOfflineFileListFieldNumber = 1;
...
// required string file_md5 = 5;
inline bool OfflineFileInfo::has_file_md5() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void OfflineFileInfo::set_has_file_md5() {
  _has_bits_[0] |= 0x00000010u;
}
inline void OfflineFileInfo::clear_has_file_md5() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void OfflineFileInfo::clear_file_md5() {
  if (file_md5_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_->clear();
  }
  clear_has_file_md5();
}
inline const ::std::string& OfflineFileInfo::file_md5() const {
  // @@protoc_insertion_point(field_get:IM.BaseDefine.OfflineFileInfo.file_md5)
  return *file_md5_;
}
inline void OfflineFileInfo::set_file_md5(const ::std::string& value) {
  set_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_ = new ::std::string;
  }
  file_md5_->assign(value);
  // @@protoc_insertion_point(field_set:IM.BaseDefine.OfflineFileInfo.file_md5)
}
inline void OfflineFileInfo::set_file_md5(const char* value) {
  set_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_ = new ::std::string;
  }
  file_md5_->assign(value);
  // @@protoc_insertion_point(field_set_char:IM.BaseDefine.OfflineFileInfo.file_md5)
}
inline void OfflineFileInfo::set_file_md5(const char* value, size_t size) {
  set_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_ = new ::std::string;
  }
  file_md5_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:IM.BaseDefine.OfflineFileInfo.file_md5)
}
inline ::std::string* OfflineFileInfo::mutable_file_md5() {
  set_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:IM.BaseDefine.OfflineFileInfo.file_md5)
  return file_md5_;
}
inline ::std::string* OfflineFileInfo::release_file_md5() {
  clear_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void OfflineFileInfo::set_allocated_file_md5(::std::string* file_md5) {
  if (file_md5_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete file_md5_;
  }
  if (file_md5) {
  ...
  // @@protoc_insertion_point(field_set_allocated:IM.BaseDefine.OfflineFileInfo.file_md5)
}

// required uint32 status = 6;
inline bool OfflineFileInfo::has_status() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void OfflineFileInfo::set_has_status() {
  _has_bits_[0] |= 0x00000020u;
}
inline void OfflineFileInfo::clear_has_status() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void OfflineFileInfo::clear_status() {
  status_ = 0u;
  clear_has_status();
}
inline ::google::protobuf::uint32 OfflineFileInfo::status() const {
  // @@protoc_insertion_point(field_get:IM.BaseDefine.OfflineFileInfo.status)
  return status_;
}
inline void OfflineFileInfo::set_status(::google::protobuf::uint32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:IM.BaseDefine.OfflineFileInfo.status)
}
...
// repeated .IM.BaseDefine.OfflineFileInfo offline_file_list = 1;
inline int InfoNotify::offline_file_list_size() const {
  return offline_file_list_.size();
}
inline void InfoNotify::clear_offline_file_list() {
  offline_file_list_.Clear();
}
inline const ::IM::BaseDefine::OfflineFileInfo& InfoNotify::offline_file_list(int index) const {
  // @@protoc_insertion_point(field_get:IM.BaseDefine.InfoNotify.offline_file_list)
  return offline_file_list_.Get(index);
}
inline ::IM::BaseDefine::OfflineFileInfo* InfoNotify::mutable_offline_file_list(int index) {
  // @@protoc_insertion_point(field_mutable:IM.BaseDefine.InfoNotify.offline_file_list)
  return offline_file_list_.Mutable(index);
}
inline ::IM::BaseDefine::OfflineFileInfo* InfoNotify::add_offline_file_list() {
  // @@protoc_insertion_point(field_add:IM.BaseDefine.InfoNotify.offline_file_list)
  return offline_file_list_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::IM::BaseDefine::OfflineFileInfo >&
InfoNotify::offline_file_list() const {
  // @@protoc_insertion_point(field_list:IM.BaseDefine.InfoNotify.offline_file_list)
