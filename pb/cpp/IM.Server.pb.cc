...
void protobuf_ShutdownFile_IM_2eServer_2eproto() {
  ...
  delete IMFileStatus::default_instance_;
}
...
void protobuf_AddDesc_IM_2eServer_2eproto() {
  ...
  IMFileStatus::default_instance_ = new IMFileStatus();
  ...
  IMFileStatus::default_instance_->InitAsDefaultInstance();
...
const int IMFileTransferReq::kFileMd5FieldNumber;
...
#ifndef _MSC_VER
const int IMFileStatus::kTaskIdFieldNumber;
const int IMFileStatus::kFileStatusFieldNumber;
#endif  // !_MSC_VER

IMFileStatus::IMFileStatus()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Server.IMFileStatus)
}

void IMFileStatus::InitAsDefaultInstance() {
}

IMFileStatus::IMFileStatus(const IMFileStatus& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Server.IMFileStatus)
}

void IMFileStatus::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
  task_id_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  file_status_ = 1;
...
IMFileStatus::~IMFileStatus() {
  // @@protoc_insertion_point(destructor:IM.Server.IMFileStatus)
  SharedDtor();
}

void IMFileStatus::SharedDtor() {
  if (task_id_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete task_id_;
  }
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
...
void IMFileStatus::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMFileStatus& IMFileStatus::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eServer_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eServer_2eproto();
...
IMFileStatus* IMFileStatus::default_instance_ = NULL;

IMFileStatus* IMFileStatus::New() const {
  return new IMFileStatus;
}

void IMFileStatus::Clear() {
  if (_has_bits_[0 / 32] & 3) {
    if (has_task_id()) {
      if (task_id_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
        task_id_->clear();
...
bool IMFileStatus::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Server.IMFileStatus)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
        ...
        if (tag == 16) {
         parse_file_status:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::IM::BaseDefine::TransferType_IsValid(value)) {
            set_file_status(static_cast< ::IM::BaseDefine::TransferType >(value));
          } else {
            unknown_fields_stream.WriteVarint32(tag);
            unknown_fields_stream.WriteVarint32(value);
          }
...
success:
  // @@protoc_insertion_point(parse_success:IM.Server.IMFileStatus)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Server.IMFileStatus)
  return false;
#undef DO_
}

void IMFileStatus::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Server.IMFileStatus)
  // required string task_id = 1;
  if (has_task_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Server.IMFileStatus)
}

int IMFileStatus::ByteSize() const {
  int total_size = 0;
...
void IMFileStatus::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMFileStatus*>(&from));
}

void IMFileStatus::MergeFrom(const IMFileStatus& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_task_id()) {
      set_task_id(from.task_id());
...
void IMFileStatus::CopyFrom(const IMFileStatus& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMFileStatus::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;

  return true;
}

void IMFileStatus::Swap(IMFileStatus* other) {
  if (other != this) {
    std::swap(task_id_, other->task_id_);
...
::std::string IMFileStatus::GetTypeName() const {
  return "IM.Server.IMFileStatus";
}
