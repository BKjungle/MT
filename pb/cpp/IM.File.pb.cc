...
const int IMFileState::kTTypeFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_TType;
        break;
      }
        ...
        if (tag == 16) {
         parse_TType:
          ...
          if (::IM::BaseDefine::TransferType_IsValid(value)) {
            set_ttype(static_cast< ::IM::BaseDefine::TransferType >(value));
          } else {
            unknown_fields_stream.WriteVarint32(tag);
            unknown_fields_stream.WriteVarint32(value);
          }
...
const int IMFileReq::kFileMd5FieldNumber;
#endif  // !_MSC_VER
...
const int IMFileAddOfflineReq::kFileMd5FieldNumber;
const int IMFileAddOfflineReq::kStatusFieldNumber;
#endif  // !_MSC_VER
...
const int IMFileDelOfflineReq::kFileNameFieldNumber;
const int IMFileDelOfflineReq::kFileSizeFieldNumber;
#endif  // !_MSC_VER
