...
class IMFileStatus : public ::google::protobuf::MessageLite {
 public:
  IMFileStatus();
  virtual ~IMFileStatus();

  IMFileStatus(const IMFileStatus& from);

  inline IMFileStatus& operator=(const IMFileStatus& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const IMFileStatus& default_instance();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const IMFileStatus* internal_default_instance() {
    return default_instance_;
  }
  #endif

  void Swap(IMFileStatus* other);

  // implements Message ----------------------------------------------

  IMFileStatus* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
  void CopyFrom(const IMFileStatus& from);
  void MergeFrom(const IMFileStatus& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // required .IM.BaseDefine.TransferType file_status = 2;
  inline bool has_file_status() const;
  inline void clear_file_status();
  static const int kFileStatusFieldNumber = 2;
  inline ::IM::BaseDefine::TransferType file_status() const;
  inline void set_file_status(::IM::BaseDefine::TransferType value);

  // @@protoc_insertion_point(class_scope:IM.Server.IMFileStatus)
 private:
  inline void set_has_task_id();
  inline void clear_has_task_id();
  ...
  void InitAsDefaultInstance();
  static IMFileStatus* default_instance_;
};
// ===================================================================
...
inline ::google::protobuf::uint64 IMFileTransferReq::file_size() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMFileTransferReq.file_size)
  return file_size_;
}
inline void IMFileTransferReq::set_file_size(::google::protobuf::uint64 value) {
  set_has_file_size();
  file_size_ = value;
...
// required string file_md5 = 6;
inline bool IMFileTransferReq::has_file_md5() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void IMFileTransferReq::set_has_file_md5() {
  _has_bits_[0] |= 0x00000020u;
}
inline void IMFileTransferReq::clear_has_file_md5() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void IMFileTransferReq::clear_file_md5() {
  if (file_md5_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_->clear();
  }
  clear_has_file_md5();
}
inline const ::std::string& IMFileTransferReq::file_md5() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMFileTransferReq.file_md5)
  return *file_md5_;
}
inline void IMFileTransferReq::set_file_md5(const ::std::string& value) {
  set_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_ = new ::std::string;
  }
  file_md5_->assign(value);
  // @@protoc_insertion_point(field_set:IM.Server.IMFileTransferReq.file_md5)
}
inline void IMFileTransferReq::set_file_md5(const char* value) {
  set_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_ = new ::std::string;
  }
  file_md5_->assign(value);
  // @@protoc_insertion_point(field_set_char:IM.Server.IMFileTransferReq.file_md5)
}
inline void IMFileTransferReq::set_file_md5(const char* value, size_t size) {
  set_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_ = new ::std::string;
  }
  file_md5_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:IM.Server.IMFileTransferReq.file_md5)
}
inline ::std::string* IMFileTransferReq::mutable_file_md5() {
  set_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    file_md5_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:IM.Server.IMFileTransferReq.file_md5)
  return file_md5_;
}
inline ::std::string* IMFileTransferReq::release_file_md5() {
  clear_has_file_md5();
  if (file_md5_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void IMFileTransferReq::set_allocated_file_md5(::std::string* file_md5) {
  if (file_md5_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete file_md5_;
  }
  if (file_md5) {
  ...
  // @@protoc_insertion_point(field_set_allocated:IM.Server.IMFileTransferReq.file_md5)
}
...
// required string task_id = 1;
inline bool IMFileStatus::has_task_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void IMFileStatus::set_has_task_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void IMFileStatus::clear_has_task_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void IMFileStatus::clear_task_id() {
  if (task_id_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    task_id_->clear();
  }
  clear_has_task_id();
}
inline const ::std::string& IMFileStatus::task_id() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMFileStatus.task_id)
  return *task_id_;
}
inline void IMFileStatus::set_task_id(const ::std::string& value) {
  set_has_task_id();
  if (task_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    task_id_ = new ::std::string;
  }
  task_id_->assign(value);
  // @@protoc_insertion_point(field_set:IM.Server.IMFileStatus.task_id)
}
inline void IMFileStatus::set_task_id(const char* value) {
  set_has_task_id();
  if (task_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    task_id_ = new ::std::string;
  }
  task_id_->assign(value);
  // @@protoc_insertion_point(field_set_char:IM.Server.IMFileStatus.task_id)
}
inline void IMFileStatus::set_task_id(const char* value, size_t size) {
  set_has_task_id();
  if (task_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    task_id_ = new ::std::string;
  }
  task_id_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:IM.Server.IMFileStatus.task_id)
}
inline ::std::string* IMFileStatus::mutable_task_id() {
  set_has_task_id();
  if (task_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    task_id_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:IM.Server.IMFileStatus.task_id)
  return task_id_;
}
inline ::std::string* IMFileStatus::release_task_id() {
  clear_has_task_id();
  if (task_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void IMFileStatus::set_allocated_task_id(::std::string* task_id) {
  if (task_id_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete task_id_;
  }
  if (task_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:IM.Server.IMFileStatus.task_id)
}

// required .IM.BaseDefine.TransferType file_status = 2;
inline bool IMFileStatus::has_file_status() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void IMFileStatus::set_has_file_status() {
  _has_bits_[0] |= 0x00000002u;
}
inline void IMFileStatus::clear_has_file_status() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void IMFileStatus::clear_file_status() {
  file_status_ = 1;
  clear_has_file_status();
}
inline ::IM::BaseDefine::TransferType IMFileStatus::file_status() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMFileStatus.file_status)
  return static_cast< ::IM::BaseDefine::TransferType >(file_status_);
}
inline void IMFileStatus::set_file_status(::IM::BaseDefine::TransferType value) {
  assert(::IM::BaseDefine::TransferType_IsValid(value));
  set_has_file_status();
  file_status_ = value;
  // @@protoc_insertion_point(field_set:IM.Server.IMFileStatus.file_status)
}
