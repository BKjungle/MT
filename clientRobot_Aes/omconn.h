...
public:
	...
	virtual void OnConnect(net_handle_t handle) { m_handle = handle; log("OnConnect ok");}
	...
	virtual void HandlePdu(CImPdu* pPdu){}// if build  this line end add {} , del 47,48
	void setsockfd(int fd);
 	void ResLoginPdu(CImPdu* pPdu);
protected:
