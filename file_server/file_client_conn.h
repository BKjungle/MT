...
#include "file_server/file_msg_server_conn.h" //add 6.16   for  send download ok to msgserver 
// TODO
// 异常情况处理
// 断线、服务器重启等
...
private:
    ...
    int _StatesNotify(int state,int TType  ,const std::string& task_id, uint32_t user_id, CImConn* conn);
